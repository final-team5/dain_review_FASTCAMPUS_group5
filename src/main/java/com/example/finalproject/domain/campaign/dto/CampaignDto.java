...
public class CampaignDto {
    ...
    public static CampaignDto of(Integer seq, UserDto userDto, String id, String category, String platform, String type, String title, String contents, String service,
                                 String keyword1, String keyword2, String keyword3, String campaignLink, String mission, Integer recruiter, String image, String city, String district,
                                 Integer point, String tag, Integer status, Date applicationStartDate, Date applicationEndDate, Date experienceStartDate, Date experienceEndDate,
                                 DateTime experienceStartTime, DateTime experienceEndTime, Integer monday, Integer tuesday, Integer wednesday, Integer thursday, Integer friday, Integer saturday, Integer sunday,
                                 Integer hashtag, Integer map, Integer link, Integer characters, Integer videoLength, Integer pictureCount, Integer accountTag, Integer sound,
                                 Integer advertisingDisplay, Timestamp registeredAt, Timestamp updatedAt) {
        return new CampaignDto(seq, userDto, id, category, platform, type, title, contents, service,
                ...
                experienceStartTime, experienceEndTime, monday, tuesday, wednesday, thursday, friday, saturday, sunday,
                hashtag, map, link, characters, videoLength, pictureCount, accountTag, sound,
                advertisingDisplay, registeredAt, updatedAt);
    }
