...
public class BusinessesController {
    ...
    @Autowired
    public BusinessesController(UserService userService) {
    ...
    public ResponseApi<?> applyAgency(@RequestBody AgencyInsertRequest insert) {
        ...
        return ResponseApi.success(HttpStatus.CREATED, userService.agencyApplication(insert, userSeq));
    }
    ...
    public ResponseApi<?> createCampaign(@RequestBody CampaignInsertRequest insert) {
        // TODO: 사용자 인증 추가
        Integer userSeq = null;
        userService.createCampaign(insert, userSeq);
    ...
    public ResponseApi<?> cancelCampaign(@RequestBody CampaignCancelRequest cancelRequest) {
        userService.cancelCampaign(cancelRequest);
    ...
    public ResponseApi<?> getCampaignDetail(@PathVariable String id) {
        // TODO: 사용자 인증 추가
        Integer userSeq = null;
        Object campaignDetail = userService.getCampaignDetail(id, userSeq);
    ...
    public ResponseApi<?> startCampaign(@PathVariable Integer seq) {
        // TODO: 사용자 인증 추가
        Integer userSeq = null;
        userService.startCampaign(seq, userSeq);
    ...
    public ResponseApi<?> getApplicationInfluencerList(@PathVariable Integer seq) {
        // TODO: 사용자 인증 추가
        Integer userSeq = null;
        List<Object> influencerList = userService.getApplicationInfluencerList(seq, userSeq);
    ...
    public ResponseApi<?> downloadInfluencerList(@PathVariable Integer seq) {
        // TODO: 사용자 인증 추가
        Integer userSeq = null;
        Object downloadLink = userService.downloadInfluencerList(seq, userSeq);
    ...
    public ResponseApi<?> getSelectedInfluencerList(@PathVariable Integer seq) {
        // TODO: 사용자 인증 추가
        Integer userSeq = null;
        List<Object> selectedInfluencerList = userService.getSelectedInfluencerList(seq, userSeq);
    ...
    public ResponseApi<?> getCommunityList(
        ...
        // TODO: 사용자 인증 추가
        Integer userSeq = null;
        List<Object> communityList = userService.getCommunityList(page, searchType, searchWord, userSeq);
    ...
    public ResponseApi<?> addCommunityPost(@RequestBody CommunityPostRequest postRequest) {
        // TODO: 사용자 인증 추가
        Integer userSeq = null;
        userService.addCommunityPost(postRequest, userSeq);
    ...
    public ResponseApi<?> updateCommunityPost(@RequestBody CommunityPostUpdateRequest updateRequest) {
        // TODO: 사용자 인증 추가
        Integer userSeq = null;
        userService.updateCommunityPost(updateRequest, userSeq);
    ...
    public ResponseApi<?> deleteCommunityPosts(@RequestBody CommunityPostDeleteRequest deleteRequest) {
        // TODO: 사용자 인증 추가
        Integer userSeq = null;
        userService.deleteCommunityPosts(deleteRequest, userSeq);
    ...
    public ResponseApi<?> getCommunityDetail(@PathVariable Integer seq) {
        // TODO: 사용자 인증 추가
        Integer userSeq = null;
        Object communityDetail = userService.getCommunityDetail(seq, userSeq);
    ...
    public ResponseApi<?> deposits(@RequestBody PaymentRequest paymentRequest) {
        // TODO: 사용자 인증 추가
        Integer userSeq = null;
        userService.deposits(paymentRequest, userSeq);
    ...
    public ResponseApi<?> updateProfile(
        ...
        // TODO: 사용자 인증 추가
        Integer userSeq = null;
        userService.updateProfile(userSeq, address, addressDetail, attachment, businessNumber, company, email, name, phone, postalCode, profile, pw, representative);
    ...
    public ResponseApi<?> selectReviewer(@RequestBody ReviewerSelectRequest selectRequest) {
        // TODO: 사용자 인증 추가
        Integer userSeq = null;
        userService.selectReviewer(selectRequest, userSeq);
